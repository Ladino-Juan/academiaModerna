...
const Home = () => {
  ...
  return (
    <>
      ...
      <div
        className="bg-blanco py-20 w-full h-screen max-sm:h-[120vh] flex justify-around items-center font-poppins relative max-sm:flex-col"
        id="licencias"
      >
        <img
        ...
        <div className="w-1/3 max-sm:w-[80vw] max-sm:text-center relative z-10">
          <h2 className="font-semibold text-2xl max-sm:text-4xl">
            NUESTROS CURSOS
          </h2>
          <br></br>
          <p className="text-base max-sm:pb-5">
            ...
            licencia de conducir de moto y carro. También te asesoramos en la
            renovación de tu licencia de conducir y consultas sobre el proceso.
            Aprende a manejar con confianza en manos de expertos. ¡Empieza tu
            camino hoy mismo!
          </p>
        </div>
      ...
      <div className="bg-white py-5">
        <div
          className="elfsight-app-16f2ac31-fccc-400b-bd77-3b87b450eb79"
      ...
      >
        <iframe
          ...
          className="w-1/3 h-2/4 max-sm:h-1/4 rounded-xl max-sm:w-[80vw]"
          allowFullScreen=""
          loading="lazy"
          referrerPolicy="no-referrer-when-downgrade"
        ></iframe>
        <div className="w-1/3 max-sm:w-[80vw] text-center">
          <h2 className="font-semibold text-2xl max-sm:text-2xl">
            Licencia de Conducir en Pereira - Academia Moderna de Automovilismo
          </h2>
          <br></br>
          <p className=" text-lg max-sm:text-lg">
            Obtén tu licencia de conducir en la mejor ubicación de Pereira,
            cerca al sector de Cuba. Academia Moderna de Automovilismo ofrece
            cursos prácticos y teóricos con más de 20 años de experiencia
            formando conductores confiables. ¡Aprende a manejar cerca de casa
